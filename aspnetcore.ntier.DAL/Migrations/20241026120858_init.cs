    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MultimediaTag", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MultimediaTag_Multimedias_MultimediaId",
                        column: x => x.MultimediaId,
                        principalTable: "Multimedias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MultimediaTag_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MultimediaTag_MultimediaId",
                table: "MultimediaTag",
                column: "MultimediaId");

            migrationBuilder.CreateIndex(
                name: "IX_MultimediaTag_TagId_MultimediaId",
                table: "MultimediaTag",
                columns: new[] { "TagId", "MultimediaId" },
                unique: true);
        }
